...
export function OurBrandingProcess({ title, description }: OurBrandingProcessProps) {
   ...
   return (
      <div className={`w-full md:max-w-2/3 mx-auto flex flex-col gap-8 border-b border-foreground not-last:mb-12 cursor-pointer ${expandedBrandingProcessList ? 'h-[180px] md:h-[200px] pb-12' : 'h-0 pb-16'} transition-all duration-300 overflow-hidden fadeUp`} onClick={toggleBrandingProcessList}>
